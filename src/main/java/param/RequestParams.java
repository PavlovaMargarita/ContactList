...
public class RequestParams {
    public static ResourceBundle bundle = ResourceBundle.getBundle("property");
    ...
    public static final String FORM_CORRECT_PERSON = "formCorrectPerson";
    public static final String SHOW_ALL_PERSONS = "showAllPersons";
    public static final String FORM_SEARCH_PERSON = "formSearchPerson";
