...
//    }
    ...
    var idIDElement = document.getElementsByName('idID');
    var idID = idIDElement[x].value;
    document.getElementById('idIDCorrect').value = idID;

    var idPersonIDElement = document.getElementsByName('idPersonID');
    var idPersonID = idPersonIDElement[x].value;
    document.getElementById('idPersonIDCorrect').value = idPersonID;
...
function saveCorrectPhone(){
    ...
    var id = document.getElementById('idIDCorrect').value;
    var idPerson = document.getElementById('idPersonIDCorrect').value;
    ...
    document.getElementsByName('idID')[rowCount].value = id;
    document.getElementsByName('idPersonID')[rowCount].value = idPerson;
}

function saveAddPhone(){
    var id = document.getElementById('idIDAdd').value;
    var idPerson = document.getElementById('idPersonIDAdd').value;
    ...
    document.getElementById('idIDAdd').value = "";
    document.getElementById('idPersonIDAdd').value = "";
    ...
    var elementIdPerson = document.createElement("input");
    elementIdPerson.type = "hidden";
    elementIdPerson.name = "idPersonID";
    elementIdPerson.value = idPerson;
    row.appendChild(elementIdPerson);
